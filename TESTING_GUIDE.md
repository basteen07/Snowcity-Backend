...
```javascript
// Send OTP
fetch('http://localhost:4000/api/auth/otp/send', {
  method: 'POST',
  headers: {
...
axios.post('http://localhost:4000/api/auth/otp/send', {
  email: 'test@example.com',
  phone: '+1234567890',
  name: 'Test User',
  channel: 'sms',
...
- Check that you're using the correct URL: `http://localhost:4000/api/auth/otp/send`
